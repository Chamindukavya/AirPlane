...
const places = [
  {
    ...
    content: (
      <p className="text-center text-gray-600">
        Explore Indonesia's beautiful beaches.
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="text-center text-gray-600">
        Visit India's historic landmarks.
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="text-center text-gray-600">
        Experience Singapore's stunning cityscapes.
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="text-center text-gray-600">
        Discover the charm of Sri Lanka's nature.
      </p>
    ),
  },
  {
        ...
        <div className="h-2/3">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
            <div className="mt-20 md:mt-32 lg:mt-48">
              {" "}
              {/* Moves content down on the video */}
              <TextGenerateEffectDemo />{" "}
              {/* Using TextGenerateEffectDemo here */}
